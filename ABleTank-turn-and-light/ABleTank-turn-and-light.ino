...
int leftMotorPins[3]    = {10, 6, 5}; //{10, 12, 11};     // pins connected to the left motor controller
int rightMotorPins[3]   = {9, 3, 11}; //{9, 5, 6};        // pins connected to the right motor controller
int maxSpeed            = 180;
int maxTurn             = 120;
...
const int BLE_MODE_PIN = 7; 

//Adafruit_BluefruitLE_UART ble(BLUEFRUIT_SERIAL_PORT, BLE_MODE_PIN);
SoftwareSerial bluefruitSS = SoftwareSerial(BLUEFRUIT_SWUART_TXD_PIN, BLUEFRUIT_SWUART_RXD_PIN);
Adafruit_BluefruitLE_UART ble(bluefruitSS, BLE_MODE_PIN, BLUEFRUIT_UART_CTS_PIN, BLUEFRUIT_UART_RTS_PIN);
